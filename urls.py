...
urlpatterns = [
    ...
    path('index/freq_spatiale_2d', views.sinus_2d,name="freq_spatiale_2d"),
    ...
    path('index/chirp_bkh', views.chirp_bkh,name="sinus_amorti_bkh"),
    path('index/chirp_slider_change', ts_bkh.ChirpBkh.chirp_slider_change,name="sinus_amorti_slider_change"),
    ...
    path('index/sinus3d', views.sinus_2d,name="trans_simil_slider_change"),
    path('index/chapeau2d', views.chapeau_2d,name="trans_simil_slider_change"),
    path('index/sinus3d_slider_change', ts_bkh.Fct2D.sinus3d_slider_change,name="sinus3d_slider_change"),
